...
ARG NEXT_PUBLIC_ALLOWED_ORIGIN_DEV
ARG NEXT_PUBLIC_ALLOWED_ORIGIN_PROD
...
ENV NEXT_PUBLIC_ALLOWED_ORIGIN_DEV=$NEXT_PUBLIC_ALLOWED_ORIGIN_DEV
ENV NEXT_PUBLIC_ALLOWED_ORIGIN_PROD=$NEXT_PUBLIC_ALLOWED_ORIGIN_PROD
