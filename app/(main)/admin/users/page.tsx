    ...
    return (
        <div className="min-h-[calc(100vh-64px)] w-full bg-[#E7F3E7] px-4 py-6 sm:px-6 sm:py-10 md:px-12 md:py-12">
            <div className="max-w-4xl mx-auto flex flex-col gap-6">
                <div>
                    <h1 className="text-2xl sm:text-[2rem] font-bold text-gray-900 tracking-tight">Users</h1>
                                                ...
                                                <div className="flex items-center gap-2">
                                                    {!isActive && (
                                                        <Button
                                                            variant="outline"
                                                            size="sm"
                                                            className="w-20 h-7 text-xs font-semibold rounded-md shadow-none border-green-500 text-green-600 hover:bg-green-50 hover:text-green-700"
                                                    ...
                                                    {isActive && (
                                                        <Button
                                                            variant="destructive"
                                                            size="sm"
                                                            className="w-20 h-7 text-xs font-semibold rounded-md shadow-none hover:bg-red-600/90 text-white"
