...
export default function Home() {
    return (
        ...
        <main className="min-h-screen">
            ...
            <section id="hero" className="relative h-screen w-full">
                ...
                <div className="relative h-full flex flex-col items-center justify-center text-center px-6">
                    ...
                    <Button 
                        ...
                        asChild
                    >
                        <Link href="/find-pet">Browse Pets Now</Link>
                    </Button>
                </div>
            </section>
            ...
            <section id="why-pawsitive" className="py-16 md:py-24 px-6 bg-gray-50">
                <div className="container mx-auto max-w-6xl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="bg-white rounded-2xl p-8 text-center shadow-sm hover:shadow-md transition-shadow">
                            <div className="inline-flex items-center justify-center w-20 h-20 bg-green-100 rounded-full mb-6">
                                <PawPrint className="w-10 h-10 text-green-600" fill="currentColor" />
                            </div>
            ...
            {/* Community Section */}
            <section id="community" className="py-16 md:py-24 px-6 bg-gradient-to-br from-green-50 to-green-100">
                <div className="container mx-auto max-w-6xl">
                    <div className="text-center mb-12">
                        <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                            Join Our Community
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="flex items-center gap-4 text-sm text-gray-500">
                                        <span className="flex items-center gap-1"><MessageCircle className="w-4 h-4" /> 24 replies</span>
                                        <span className="flex items-center gap-1"><ThumbsUp className="w-4 h-4" /> 156 likes</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl p-6 shadow-md">
                            <div className="flex items-start gap-4">
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="flex items-center gap-4 text-sm text-gray-500">
                                        <span className="flex items-center gap-1"><MessageCircle className="w-4 h-4" /> 48 replies</span>
                                        <span className="flex items-center gap-1"><ThumbsUp className="w-4 h-4" /> 320 likes</span>
                                    </div>
                                </div>
                            </div>
                        </div>
